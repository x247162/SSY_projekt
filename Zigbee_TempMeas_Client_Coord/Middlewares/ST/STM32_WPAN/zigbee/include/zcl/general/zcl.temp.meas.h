...
enum ZbZclColorMeasSvrAttrT {
    ZCL_COLOR_MEAS_ATTR_MEAS_VAL = 0x0000, /**< MeasuredValue */
    ZCL_COLOR_MEAS_ATTR_MIN_MEAS_VAL = 0x0001, /**< MinMeasuredValue */
    ZCL_COLOR_MEAS_ATTR_MAX_MEAS_VAL = 0x0002, /**< MaxMeasuredValue */
    ZCL_COLOR_MEAS_ATTR_TOLERANCE = 0x0003 /**< Tolerance (Optional) */
};
...
struct ZbZclClusterT * ZbZclColorMeasClientAlloc(struct ZigBeeT *zb, uint8_t endpoint);
